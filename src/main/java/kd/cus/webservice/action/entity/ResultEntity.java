package kd.cus.webservice.action.entity;
...
import kd.bos.message.service.pa.ThumbnailSizeEnum;
import kd.bos.workflow.engine.impl.cmd.SetProcessInstanceNameCmd;
