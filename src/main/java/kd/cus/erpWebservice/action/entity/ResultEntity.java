package kd.cus.erpWebservice.action.entity;
...
//	SUCCESS("成功","0");
	...
	public static ResultEntity ADJUST_SKERROR() {
		return new ResultEntity("ADJUST_SKERROR","司库调用失败","1");
	}
	...
	public static String resultXML(List<ResultEntity> wsresults) {
		StringBuffer xmls = new StringBuffer("");
		wsresults.forEach(wsresult->{
			xmls.append(wsresult.singleXml());
		});
		return "<?xml version=\"1.0\" encoding=\"UTF-8\"?><DATAINFOS>" + xmls.toString() + "</DATAINFOS>";
	}
}
